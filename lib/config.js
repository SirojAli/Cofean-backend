...
exports.member_type_enums = ["ADMIN", "CAFE", "USER", "DELIVER"];
...
exports.order_status_enums = ["PROCESS", "PAID", "CANCELLED", "DELIVERED"];

exports.like_view_enums = ["member", "product", "community"]; // member = cafe
